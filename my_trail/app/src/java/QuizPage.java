...
public class QuizPage extends AppCompatActivity {
    ...
    private void checkAnswer(String selectedAnswer, TextView option) {
        ...
        if (quizCorrectAnswer.equals(userAnswer)) {
            option.setBackground(ContextCompat.getDrawable(this, R.drawable.gradiant4));
            userCorrect++;
            correct.setText(String.valueOf(userCorrect));
        } else {
            option.setBackground(ContextCompat.getDrawable(this, R.drawable.gradiant5)); 
            userWrong++;
